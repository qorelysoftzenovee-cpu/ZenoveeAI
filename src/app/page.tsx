      ...
      <header className="sticky top-0 z-50 bg-white/70 backdrop-blur-md border-b border-slate-200/60 transition-all duration-300">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-6">
            <Link href="/features" className="text-xs font-semibold text-slate-650 hover:text-indigo-650 transition-colors uppercase tracking-wider">Features</Link>
            <Link href="/pricing" className="text-xs font-semibold text-slate-650 hover:text-indigo-650 transition-colors uppercase tracking-wider">Pricing</Link>
            <Link href="/about" className="text-xs font-semibold text-slate-650 hover:text-indigo-650 transition-colors uppercase tracking-wider">About</Link>
            <Link 
              href="/dashboard" 
              className="inline-flex items-center justify-center bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-xs px-4 py-2 rounded-xl shadow-sm transition-all uppercase tracking-wider"
            >
              Launch Workspace
            </Link>
          </nav>
        ...
        <div className="max-w-2xl mx-auto mb-16">
          <div className="bg-white border border-slate-200 shadow-md rounded-2xl p-2.5 flex items-center gap-3">
            ...
            <input 
              ...
              className="flex-1 bg-transparent text-sm text-slate-800 placeholder:text-slate-400 outline-none pr-4"
            />
            {searchQuery && (
              <button 
            ...
            <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
              {filteredTools.map((tool) => (
                ...
                >
                  ...
                  <h3 className="font-extrabold text-slate-900 group-hover:text-indigo-650 transition-colors leading-snug">
